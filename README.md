...
## Monogdb
Below are the steps on how to integrate monogdb in nestJs project
https://docs.nestjs.com/techniques/mongodb

Also view the below youtube video on how to create mongodb cluster, database and collection
...
Also view the below youtube video for more clear understand of its configuration and other properties that we can use.
